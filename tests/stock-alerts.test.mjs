...
const email = buildStockAlertEmail({ marketName:'Mercado Teste', brand:{ name:'Mercadinho Azul',primaryColor:'#2563eb',secondaryColor:'#172554',contactPhone:'(71) 99999-9999',footer:'Obrigado pela parceria.' }, products:report, generatedAt:now.toISOString() });
assert.match(email.subject, /Mercadinho Azul/);
assert.match(email.html, /Muito vendido/);
assert.match(email.html, /#2563eb/);
assert.match(email.html, /Obrigado pela parceria/);
