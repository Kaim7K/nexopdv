...
assert.match(quickModal, /Preço de venda/, 'O cadastro rápido deve permitir informar o preço necessário para concluir a venda.');
assert.doesNotMatch(quickModal, /Google Imagens|URL da imagem/, 'A imagem deve permanecer na tela completa de produtos.');
