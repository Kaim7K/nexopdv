...
export const AuthProvider = ({ children }) => {
  ...
  return <AuthContext.Provider value={{user,isAuthenticated:!!user,isLoadingAuth,isLoadingPublicSettings:false,authChecked,authError:null,checkUserAuth,logout,navigateToLogin:()=>{window.location.href='/login';}}}>{children}</AuthContext.Provider>;
};
