    ...
    return (
      <main className="grid min-h-dvh place-items-center bg-background p-5 text-center">
        <div className="surface-card max-w-md p-6 sm:p-8" role="alert">
          ...
          <button type="button" onClick={() => window.location.reload()} className="mt-5 min-h-11 rounded-xl bg-accent px-5 text-sm font-bold text-accent-foreground hover:bg-accent/90">
            Recarregar sistema
          </button>
        </div>
      </main>
