...
export default function ModuleSwitch({
  ...
  return (
    <label
      className={`flex cursor-pointer items-center justify-between gap-3 rounded-lg border px-3.5 shadow-sm transition duration-150 ease-out ${
        compact ? 'min-h-11 py-2' : 'min-h-[66px] py-3'
      } ${
        checked
        ...
        disabled
          ...
          : 'hover:border-accent/35 hover:bg-muted/35'
      }`}
    >
